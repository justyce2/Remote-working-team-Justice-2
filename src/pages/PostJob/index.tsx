...
const PostJob = () => {
  ...
  return (
    <div>
      <div className="max-w-70 mx-auto mt-8 lg:pl-8 xl:pl-16">
        <h1 className="text-3xl font-bold mb-6 font-normal leading-57 tracking-0 text-left" style={{ color: '#111827', fontFamily:'Code Pro LC', fontSize:'48px' }}>
            Post a Job
        </h1>
    </div>
    <div className="p-6 bg-white  max-w-2xl mx-auto mt-8">
